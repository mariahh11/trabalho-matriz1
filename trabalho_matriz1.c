...
void voltando_menu()
{
    ...
    void scanMatrix(int m, int n, int matrix[MAX][MAX])
    {
        ...
        // da pra apagar depois, eh so pra ver se ta printando certo
        printf("matrix lida:\n");
        for (int i = 0; i < m; i++)
        {
            for (int j = 0; j < n; j++)
    ...
    int main()
    {
        ...
        do
        {
            ...
            case 4:
            {
                int indexOne, indexTwo, matrix[m][n];

                printf("Digite os indices da sua matriz: \n");
                ...
                for (int j = 0; j < n; j++)
                {
                    concat[k++] = matrix[indexOne][j];
                }

                for (int j = 0; j < n; j++)
                {
                    concat[k++] = matrix[indexTwo][j];
                }
    ...
    // Imprimir a matriz final, usando pra testar ocase 4: {
    int indexOne, indexTwo, matrix[m][n];
    ...
    break;
    código.mostrar_matriz(m, n, matriz, -1);
